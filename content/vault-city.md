...
If you instead talk to a resident you'll learn that the mole rats are the only reason Vault City hasn't invaded to take them all prisoner. There is a better and more peaceful way of solving the problem (worth 1000 XP). It's very intertwined with the first quest for the [Vault Village](/vault-village/#1-get-weapons-for-connar-to-be-used-at-the-nearby-village), so it will be covered there instead.
