...
{{< note >}}If you have previously met Councilman McClure when you first talk to Connar, you will have the option to suggest making a deal with McClure. This way has the same solution as the one just above, except you don't get any money. You don't get more xp either, so not a very good idea.{{< /note >}}

{{< note >}}If you take the money from Connar but later decide to go with the McClure way instead you get to keep half the money. (Or all of it if you rather want to, but why would you want that?){{< /note >}}

{{< note >}}If you already happen to have the guns with you the first time you talk to Connar, you can give them to him straight away and get paid $5000 plus the same xp reward as otherwise. You can also try to squeeze out another $1000 from him (small speech roll).{{< /note >}}

{{< note >}}When talking to old Joe, you can get a 10mm pistol by initially pretending you know him.{{< /note >}}
