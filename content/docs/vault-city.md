...
If you instead talk to a resident you'll learn that the mole rats are the only reason Vault City hasn't invaded to take them all prisoner. There is a better and more peaceful way of solving the problem (worth 1000xp). It's very intertwined with the first quest for the [Vault Village](/docs/vault-village/), so it will be covered there instead.
