...
He wants you to go to the EPA and get some unique seeds and then he will give you something to deliver to the Shi. It's the experimental seeds that can be found in the [Green Level](/epa/#green-level) of the EPA. Just use the terminal to get it from the seed bank. You get 1000 XP for giving them to Dr. Sheng.
...
1. Who was the founder? = Dick Hubbel.
2. The church believes everything is symbolized by? = A turning wheel.
3. What is meant by Enlightenment? = A state achieved when the seeker has gained so much knowledge he becomes an integral part of the universe and leaves this earthly existence behind.
...
|-------------|----------|--------------------------|
| Combat armor (1) | Large cell (150) | $3000-5000 |
| H&K P90c | Small cell (80) | A Watch (1-2) |
| .223 pistol | AP rocket (1) | Necklace (1-3) |
| Tesla armor (1) | Leather armor mark II | Old Coin (0-2) |
| Expanded lock pick set | Scout manual (1) | Expired GECK (right safe only) |
| Super tool kit | Dean's Electronics (1) | |
...
{{< note >}}The exact amount a safe contains is randomly chosen the first time you enter the map (1st floor).{{< /note >}}
